...
while read line; do
	...
	echo $start_co
	echo $end_co
	#vcftools --vcf Tce1.fb.vcf --chr $scaffold --from-bp $start_co --to-bp $end_co --mac 3 --minQ 30 --minDP 5 --maxDP 50 --TajimaD 100000 --out $genename
 #done<tce_ajd.txt
	vcftools --vcf Tce1.fb.vcf --chr $scaffold --from-bp $start_co --to-bp $end_co --mac 3 --minQ 30 --minDP 5 --maxDP 50 \
