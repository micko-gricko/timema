...
vcftools --vcf Tcm1.fb.vcf --remove-ind tcm_m32.bam --mac 3 --MinQ 30 --minDP 5 --maxDP 50 --freq --counts --depth --weir-fst-pop tcm1.txt --weir-fst-pop tcm2.txt --TajimaD 1000 
